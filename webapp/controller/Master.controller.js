...
sap.ui.define([
		...
		return BaseController.extend("via.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("via.view.ViewSettingsDialog", this);
