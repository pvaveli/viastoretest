				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "Alphabetical_list_of_products (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'Alphabetical_list_of_products (0)'");
							},
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "Alphabetical_list_of_products (" + iExpectedLength + ")"}),
									success : function () {
