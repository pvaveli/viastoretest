					...
					iChangeTheHashToObjectN : function (iObjIndex) {
						return this.waitFor(this.createAWaitForAnEntitySet({
							...
							success : function (aEntitySet) {
								Opa5.getHashChanger().setHash("/Alphabetical_list_of_products/" + aEntitySet[iObjIndex].ProductID);
							}
						}));
					},
					...
					iShouldSeeTheHashForObjectN : function (iObjIndex) {
						return this.waitFor(this.createAWaitForAnEntitySet({
							...
							success : function (aEntitySet) {
								...
								Opa5.assert.strictEqual(sHash, "Alphabetical_list_of_products/" + aEntitySet[iObjIndex].ProductID, "The Hash is not correct");
							}
						}));
					},
